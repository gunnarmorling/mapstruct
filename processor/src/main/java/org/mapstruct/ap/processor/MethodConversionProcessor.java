...
/**
 * A {@link ModelElementProcessor} which converts the given list of {@link Method}s into corresponding
 * {@link MappingMethod}s, containing {@link PropertyMapping}s for all mapped properties.
 *
 * @author Gunnar Morling
 */
public class MethodConversionProcessor implements ModelElementProcessor<List<Method>, List<MappingMethod>> {
    ...
    @Override
    public List<MappingMethod> process(ProcessorContext context, TypeElement mapperTypeElement,
        ...
        ReportingPolicy unmappedTargetPolicy = getEffectiveUnmappedTargetPolicy( mapperTypeElement );
        return getMappingMethods( sourceModel, unmappedTargetPolicy );
    }
